...
const validationSchema = yup.object({
    ...
    output1:yup.string()
    .required("Vui lòng nhập Output1"),
        ...
        <div className="demo">
            ...
            <Formik
                ...
                <Form className ="FormikHomeWork">
                    ...
                    <MyInput type="datetime-local" name="deadLine" label="Deadline" format="dd/MM/yyyy" InputLabelProps={{shrink: true,}}/>
                    ...
                    <Button id="createHomeWork" color="primary" type="submit" name="createHomeWork" onClick={handelSubmit}>Tạo bài tập</Button>
                </Form>
                }
            </Formik>
        </div>
