...
const setHomeWork = (values) => {  
  ...
  firebaseApp.database().ref("Homework").update({
      NumberHW: numberHW + 1
  });

  firebaseApp.database().ref("Homework/Test/Homework"+numberHW).set({
    Title: values.title,
  ...
  firebaseApp.database().ref("Homework/Test/Homework"+numberHW+"/Expected_Output/Expect1").set({
    Input: values.input1,
    Output: values.output1,
  });

  if (step > 1) {
    firebaseApp.database().ref("Homework/Test/Homework"+numberHW+"/Expected_Output/Expect2").set({
      Input: values.input2,
  ...
  if (step > 2) {
    firebaseApp.database().ref("Homework/Test/Homework"+numberHW+"/Expected_Output/Expect3").set({
      Input: values.input3,
  ...
  if (step > 3) {
    firebaseApp.database().ref("Homework/Test/Homework"+numberHW+"/Expected_Output/Expect4").set({
      Input: values.input4,
  ...
  if (step > 4) {
    firebaseApp.database().ref("Homework/Test/Homework"+numberHW+"/Expected_Output/Expect5").set({
      Input: values.input5,
